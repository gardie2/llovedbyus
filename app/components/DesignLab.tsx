  ...
  const handleDownloadDesign = async () => {
    ...
    try {
      ...
      for (const el of placedElements) {
        // Render foto yang dimasukkan ke dalam slot elemen (jika ada)
        if (el.slotImages) {
          for (const [slotIdxStr, slotImgUrl] of Object.entries(el.slotImages)) {
            ...
            try {
              ...
              // Kliping khusus area slot elemen 24, 25, atau 32
              ctx.beginPath();
        ...
        // Render Bingkai/Stiker utamanya
        try {
      ...
      // 4. Render Mockup Overlay (Bagian Depan)
      if (mockupTp) {
        try {
